...
- 「エディアカラ級-TE」のモジュールを修正

### 1.40.17

- 「エディアカラ級」のモジュールを修正（B→A、D→B、E→D、D2を追加）
- 「プレデター級　Ｃ対空型」の戦略を更新
- 「艦船一覧」から現在入手できない艦船を除外（既に保存した編成への影響はありません）

### 1.40.16

- 「艦舶・艦載機設計図ファイル2.0」に「タンプル1号」を追加
- 「艦舶・艦載機設計図ファイル」に「タンプル1号」を追加
- 「暗号化技術ファイル2.0-ジュピター」に「タンプル1号」を追加
