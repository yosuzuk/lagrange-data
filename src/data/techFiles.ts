...
export const techFiles: ITechFile[] = [
    ...
    {
        id: 'blackMarketTechFileV2Noma',
        name: '暗号化技術ファイル2.0-ノマシッピング',
        translatedName: {
            en: 'Black Market Tech Files 2.0 - Noma Shipping',
        },
        desciption: '日替わり箱',
        translatedDescription: {
    ...
    {
        id: 'blackMarketTechFileV2Jupiter',
        name: '暗号化技術ファイル2.0-ジュピター',
        translatedName: {
            en: 'Black Market Tech Files 2.0 - Jupiter',
        },
        desciption: '日替わり箱',
        translatedDescription: {
            en: '300 Proxima coins',
    ...
    {
        id: 'blackMarketTechFileV2Antonios',
        name: '暗号化技術ファイル2.0-アントニオス',
        translatedName: {
            en: 'Black Market Tech Files 2.0 - Antonios',
        },
        desciption: '日替わり箱',
        translatedDescription: {
            en: '300 Proxima coins',
    ...
    {
        id: 'blackMarketTechFileV2Dawn',
        name: '暗号化技術ファイル2.0-ドーン基準',
        translatedName: {
            en: 'Black Market Tech Files 2.0 - Dawn',
        },
        desciption: '日替わり箱',
        translatedDescription: {
            en: '300 Proxima coins',
    ...
    {
        id: 'twinFestivalTechFiles',
        name: '双子祭技術ファイル',
        translatedName: {
            en: 'Twin Festival Tech Files',
        },
        desciption: '期間限定',
        translatedDescription: {
            en: 'Time limited',
    ...
    {
        id: 'twinTradeFairTechFiles',
        name: '双子貿易技術ファイル',
        translatedName: {
            en: 'Twin Trade Fair Tech Files',
        },
        desciption: '期間限定',
        translatedDescription: {
            en: 'Time limited',
    ...
    {
        id: 'earthDayTechFiles',
        name: 'アースデイ技術ファイル',
        translatedName: {
            en: 'Earth Day Tech Files',
        },
        desciption: '期間限定',
        translatedDescription: {
            en: 'Time limited',
