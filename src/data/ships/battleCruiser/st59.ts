                ...
                parts: [
                    {
                        ...
                        skillSlots: 7,
                        skills: [
                            skills.rapidFire(80, 60, 15, 10).withCost(15),
                ...
                parts: [
                    {
                        ...
                        skills: [
                            ...
                            skills.increaseCriticalDamageAndChance().withValue(50).withCost(8),
                            skills.increaseDamage().withValue(10).withCost(8),
                            skills.reduceTorpedoInterception().withValue(30).withCost(8),
                            skills.reduceCooldown().withValue(14.8).withCost(8),
                            skills.reduceCooldown().withValue(14.8).withCost(8),
                            skills.rapidFire(80, 60, 15, 10).withCost(15),
                        ],
                ...
                parts: [
                    {
                        ...
                        skillSlots: 4,
                        skills: [
                            skills.reduceLockOnOfAircraft().withValue(70).withCost(8),
                            skills.reduceRtbAircraft().withValue(20).withCost(8),
                            skills.reduceRtbAircraft().withValue(20).withCost(8),
                            skills.increaseHitRateOfAircraft().withValue(20).withCost(8),
                            skills.increaseDamageOfAircraft().withValue(10).withCost(8),
                        ],
                    },
                ],
                category: 'B',
                ...
                parts: [
                    {
                        ...
                        skillSlots: 3,
                        skills: [
                            skills.reduceLockOnOfUav().withValue(70).withCost(10),
                            skills.reduceRtbUav().withValue(20).withCost(10),
                            skills.increaseHitRateOfUav().withValue(20).withCost(10),
                            skills.increaseMissileEvasionOfUav().withValue(30).withCost(10),
                        ],
                    },
                ],
                category: 'B',
