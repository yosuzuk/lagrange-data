...
const input = `
    ...
    (5630,3550)(5640,3560) #c0077ff
    (5630,3540)(5640,3550) #c0077ff
    (5620,3560)(5630,3570) #cBE393A
    $station
    (5615,3555) #c0077ff
    (5625,3565) #cBE393A NPC
    (5635,3555) base #c0077ff Player
    (5635,3545) base #c0077ff プレイヤー
`;
