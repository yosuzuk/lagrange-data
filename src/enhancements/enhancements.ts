...
export const enhancements = {
    ...
    increaseCannonDamage: () => new Enhancement(EnhancementType.SKILL, EnhancementSubType.INCREASE_CANNON_DAMAGE),
    ...
    increaseCriticalChance: () => new Enhancement(EnhancementType.SKILL, EnhancementSubType.INCREASE_CRITICAL_CHANCE),
    ...
    increaseRepairSpeedOfAuxiliary: () => new Enhancement(EnhancementType.SKILL, EnhancementSubType.INCREASE_REPAIR_SPEED_OF_AUXILIARY),
    ...
    increaseSlowHitRateBackRow: () => new Enhancement(EnhancementType.SKILL, EnhancementSubType.INCREASE_SLOW_HITRATE_BACK_ROW),
    ...
    reduceHitByAircraft: () => new Enhancement(EnhancementType.SKILL, EnhancementSubType.REDUCE_HIT_BY_AIRCRAFT),
