...
export const strategy = {
    ...
    prioritizeTargets: (duration?: number) => new Enhancement(EnhancementType.STRATEGY, EnhancementSubType.PRIORITIZE_TARGETS).withDescriptionKey(duration ? 'prioritizeTargetsWithDuration' : 'prioritizeTargets'),
