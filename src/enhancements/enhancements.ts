...
export const enhancements = {
    ...
    increaseTorpedoHitRateBackRow: () => new Enhancement(EnhancementType.SKILL, EnhancementSubType.INCREASE_TORPEDO_HITRATE_BACK_ROW),
    increaseMissileHitRateBackRow: () => new Enhancement(EnhancementType.SKILL, EnhancementSubType.INCREASE_MISSILE_HITRATE_BACK_ROW),
